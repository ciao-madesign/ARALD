...
Non è urgente/bloccante — resta una scelta aperta per la prossima sessione, non un bug che rompe qualcosa oggi. Vedi anche la nota sul futuro restyling grafico della UI mobile più sopra ("Stato del progetto") — un altro punto annotato ma non ancora pianificato in dettaglio.
