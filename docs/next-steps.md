...
## Piano d'insieme (25 agosto 2026, aggiornato dopo #28-41) — come ordinare tutti i candidati aperti

Con l'Opzione I (news evoluto) **completata per intero**, la messaggistica dell'Opzione J (chat 1:1 + canali pubblici) **completata per intero**, e il tracciamento posizione dell'Opzione J ancora da valutare/decidere con l'utente — e con il debito di design UI mobile, `ContentStore`, l'intera evoluzione news (parser RSS, livelli headline/summary, digest AI, `service://emergency-news` con il suo follow-up #41), il prerequisito architetturale condiviso, la chat 1:1 e i canali pubblici **già completati** (voci #28-41, `docs/security.md` — vedi "Stato del progetto" in `CLAUDE.md`), questo piano riordina i candidati **rimasti** in un'unica sequenza motivata — per dipendenze reali, non solo per data di scoperta — pensata per essere seguita passo per passo, non per essere fatta tutta insieme. Le fasi "0" - "5" sono barrate sotto come riferimento storico di come questo piano è stato pensato, non perché vadano ancora fatte.
