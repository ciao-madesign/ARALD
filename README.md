...
- [`docs/beacon.md`](docs/beacon.md) — NOMAD Card: dispositivo radio unico (formato carta di credito) che unifica Beacon ed Emergency Relay in tre profili firmware (Beacon/Relay/Beacon+Relay Mode), più Fixed Relay/Relay Registry e una nota sulla conformità normativa UE (RED, ETSI EN 300 328/300 220, CE) per un'eventuale commercializzazione futura — documentazione di riferimento, nessun codice ancora
