...
- [`docs/beacon.md`](docs/beacon.md) — NOMAD-NET BEACON: espansione proposta, dispositivo fisico di richiesta di soccorso a bassissimo consumo (documentazione di riferimento, nessun codice ancora)
